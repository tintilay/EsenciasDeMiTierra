...
class ArtistasWidget extends StatefulWidget {
  const ArtistasWidget({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(2.0, 0.0, 0.0, 5.0),
                      child: Text(
              ...
              Padding(
                ...
                child: FutureBuilder<List<PerfilArtistaRow>>(
                  future: PerfilArtistaTable().queryRows(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<PerfilArtistaRow> listViewPerfilArtistaRowList =
                        snapshot.data!;
                    return ListView.builder(
                      ...
                      itemCount: listViewPerfilArtistaRowList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewPerfilArtistaRow =
                            listViewPerfilArtistaRowList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 16.0, 8.0),
                          child: FutureBuilder<List<UsuariosRow>>(
                            future: UsuariosTable().querySingleRow(
                              queryFn: (q) => q.eq(
                                'id',
                                listViewPerfilArtistaRow.usuarioId,
                              ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              List<UsuariosRow> userList5UsuariosRowList =
                                  snapshot.data!;
                              final userList5UsuariosRow =
                                  userList5UsuariosRowList.isNotEmpty
                                      ? userList5UsuariosRowList.first
                                      : null;
                              return Container(
                                width: double.infinity,
                                height: 60.0,
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            userList5UsuariosRow?.urlPerfil,
