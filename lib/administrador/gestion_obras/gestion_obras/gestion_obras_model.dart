...
import 'dart:async';
import 'gestion_obras_widget.dart' show GestionObrasWidget;
...
class GestionObrasModel extends FlutterFlowModel<GestionObrasWidget> {
  ...
  Completer<List<ObrasRow>>? requestCompleter2;
  Completer<List<DisciplinasRow>>? requestCompleter1;
