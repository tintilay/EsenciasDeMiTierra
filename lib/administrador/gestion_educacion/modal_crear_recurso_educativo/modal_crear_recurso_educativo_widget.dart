...
import 'modal_crear_recurso_educativo_model.dart';
export 'modal_crear_recurso_educativo_model.dart';

class ModalCrearRecursoEducativoWidget extends StatefulWidget {
  const ModalCrearRecursoEducativoWidget({Key? key}) : super(key: key);

  @override
  _ModalCrearRecursoEducativoWidgetState createState() =>
      _ModalCrearRecursoEducativoWidgetState();
}

class _ModalCrearRecursoEducativoWidgetState
    extends State<ModalCrearRecursoEducativoWidget> {
  late ModalCrearRecursoEducativoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCrearRecursoEducativoModel());
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await RecursosEducativosTable().insert({
