  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case VistaconteotecnicasRow:
            return VistaconteotecnicasRow(data);
          case RecursosEducativosRow:
            return RecursosEducativosRow(data);
          case GaleriasRow:
            return GaleriasRow(data);
          case ProfesionesRow:
            return ProfesionesRow(data);
          case VistaconteodisciplinasRow:
            return VistaconteodisciplinasRow(data);
          case ObrasRow:
            return ObrasRow(data);
          case ServiciosEducativosRow:
            return ServiciosEducativosRow(data);
          case VistaconteoobrasRow:
            return VistaconteoobrasRow(data);
          case MiembrosGrupoRow:
            return MiembrosGrupoRow(data);
          case VistaconteoestilosRow:
            return VistaconteoestilosRow(data);
          case EstilosRow:
            return EstilosRow(data);
          case DisciplinasRow:
            return DisciplinasRow(data);
          case NoticiasRow:
            return NoticiasRow(data);
          case TipoNoticiaRow:
            return TipoNoticiaRow(data);
          case VistaconteonoticiasactivasRow:
            return VistaconteonoticiasactivasRow(data);
          case TipoRecursoEducativoRow:
            return TipoRecursoEducativoRow(data);
          case VistaconteogaleriasRow:
            return VistaconteogaleriasRow(data);
          case ArtistaProfesionesRow:
            return ArtistaProfesionesRow(data);
          case TecnicasRow:
            return TecnicasRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case VistaconteonoticiasRow:
            return VistaconteonoticiasRow(data);
          case PerfilArtistaRow:
            return PerfilArtistaRow(data);
          case MaterialesRow:
            return MaterialesRow(data);
          case NotificacionesRow:
            return NotificacionesRow(data);
          case VistaconteomaterialesRow:
            return VistaconteomaterialesRow(data);
          case DisciplinaPerfilRow:
            return DisciplinaPerfilRow(data);
          case EventosRow:
